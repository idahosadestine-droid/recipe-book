...
let recipes = [
    ...
    {id:4,name:'Beef Burger',category:'lunch',cuisine:'American',emoji:'🍔',
    ingredients:['500g ground beef','Burger buns','Lettuce','Tomato','Cheese','Onion','Pickles','Ketchup','Mustard','Salt','Pepper'],
    instructions:'Form patties, grill beef, assemble with toppings.',isFavorite:false},
